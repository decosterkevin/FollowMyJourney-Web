...
var address = "1JedazahLNtQetAHfNhsmvi6qtm5KKpJLr"; // The bitcoin address to receive donations. Change to yours
...
var organization = "Kevin"; // Change to your organization name
...
function composeDonationElements(bitcoinAmountToDonate, fiatDonationAmount) {
    ...
    var donateDisplayMessage = " Paiement to " + bitcoinAmountToDonate.toString() + " Bitcoin" + fiatAmountToDonateMessage;
    if (mbits == true) {
